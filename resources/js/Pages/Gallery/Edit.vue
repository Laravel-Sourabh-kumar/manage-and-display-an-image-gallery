...
const form = useForm({
    image_url: gallery.data.image_url,
...
const submit = () => {
    form.put(route("gallerys.update", gallery.data.id), {
        preserveScroll: true,
    });
};
</script>
                            ...
                            <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Use this form to update a Gallery Detail.
                                    </p>
                                    <img :src="'http://gallary.test/'+ gallery.data.image_url" alt="" srcset="" class="h-20 w-100 max-w-xs ">   
